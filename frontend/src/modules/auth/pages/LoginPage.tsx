    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      >
        ...
        <div className="relative">
          <h1 className="text-white text-4xl font-bold tracking-tight leading-tight mb-4">
            Cálculo de frete<br />inteligente para<br />gôndolas
          </h1>
          <p className="text-white/70 text-base leading-relaxed max-w-sm">
            Extraia dados de PDFs automaticamente, calcule rotas, pedágios e volumetria em segundos.
          </p>
          <div className="mt-10 grid grid-cols-3 gap-4">
            {[
              { icon: <TrendingUp size={18} />, value: '8.4k m³', label: 'Volume/mês' },
              { icon: <Package size={18} />, value: '47', label: 'Propostas hoje' },
              { icon: <Truck size={18} />, value: '72%', label: 'Taxa aprovação' },
            ].map((stat) => (
      ...
      <div className="flex items-center justify-center p-6 bg-[#F8FAFC]">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8">
            <h2 className="text-[28px] font-bold text-tx tracking-tight mb-1">Bem-vindo de volta</h2>
            <p className="text-tx-3 text-[14px]">Entre com suas credenciais para acessar o sistema</p>
          </div>
